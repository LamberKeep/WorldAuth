...
/**
 * Called when a player get unregistered from the server successfully.
 */
public class UnregisterEvent extends PlayerEvent implements Cancellable {

  private static final HandlerList HANDLERS = new HandlerList();
  private Boolean isCancelled = false;

  public UnregisterEvent(Player who) {
    super(who);
  }
