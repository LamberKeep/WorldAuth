...
/**
 * Called when a player is logs out from the server successfully.
 */
public class LogoutEvent extends PlayerEvent implements Cancellable {

  private static final HandlerList HANDLERS = new HandlerList();
  private Boolean isCancelled = false;

  public LogoutEvent(Player who) {
    super(who);
  }
