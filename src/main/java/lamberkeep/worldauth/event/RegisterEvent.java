...
/**
 * Called when a player is registering to the server successfully.
 */
public class RegisterEvent extends PlayerEvent implements Cancellable {

  private static final HandlerList HANDLERS = new HandlerList();
  private Boolean isCancelled = false;

  public RegisterEvent(Player who) {
    super(who);
  }
